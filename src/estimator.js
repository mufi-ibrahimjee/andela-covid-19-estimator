const covid19ImpactEstimator = (data) => {
  ...
  return {
    ...
    impact: {
      ...
      dollarsInFlight: Math.round((calci * given.region.avgDailyIncomeInUSD * time1) * 100) / 100
    },
    severeImpact: {
      ...
      dollarsInFlight: Math.round((calcs * given.region.avgDailyIncomeInUSD * time1) * 100) / 100
